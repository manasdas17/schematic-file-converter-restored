...
class DesignTests(unittest.TestCase):
    ...
    def test_bounds_nets(self):
        ...
        tl, br = self.des.bounds()
        self.assertEqual(tl.x, 2)
        self.assertEqual(tl.y, 1)
        self.assertEqual(br.x, 7)
        self.assertEqual(br.y, 9)
    ...
    def test_bounds_neg_coords(self):
        ...
        tl, br = self.des.bounds()
        self.assertEqual(tl.x, -3)
        self.assertEqual(tl.y, -4)
        self.assertEqual(br.x, -1)
